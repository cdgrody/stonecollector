...
urlpatterns = [
    ...
    path('stones/<int:stone_id>/assoc_movie/<int:movie_id>', views.assoc_movie, name='assoc_movie'),
    path('stones/<int:stone_id>/unassoc_movie/<int:movie_id>', views.unassoc_movie, name='unassoc_movie'),
